...
**Connecting the Unity Editor to LLMs using the Model Context Protocol.**

Unity MCP acts as a bridge, allowing AI assistants (currently Claude, working on supporting Gemini 2.5) to interact directly with the Unity Editor via a local **MCP (Model Context Protocol) Client**. This gibes LLMs the tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

---

## Key Features 🚀

*   **🗣️ Natural Language Control:** Instruct an LLM to perform Unity tasks.
...
4.  Enter:
    ```
    https://github.com/PlayTingz/unity-mcp.git?path=/UnityMcpBridge
    ```
5.  Click `Add`.
